...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-636-even-vs-odd-latin-squares-9b7c5790-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-636"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-636-even-vs-odd-latin-squares-9b7c5790-v1",
      "problem_contract_sha256": "75033a6a9226e084a370e695d4d272715e3ad87cce3aea067cd0749e3a7c2f63",
      "problem_id": "problem:um-opg-636-even-vs-odd-latin-squares-9b7c5790",
      "route_id": "route:um-opg-636-even-vs-odd-latin-squares-9b7c5790-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-636-even-vs-odd-latin-squares-9b7c5790-source-fidelity-01",
      "graph_id": "graph:um-opg-636-even-vs-odd-latin-squares-9b7c5790-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-636-even-vs-odd-latin-squares-9b7c5790-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-636-even-vs-odd-latin-squares-9b7c5790-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "A latin square is even if the product of the signs of all of the row and column permutations is 1 and is odd otherwise. Conjecture For every positive even integer $n$, the number of even latin squares of order $n$ and the number of odd latin squares of order $n$ are different."
          },
          "statement_sha256": "fcf64db9f027e5a97305382c72bd8df055ba901309042a35558790bc8ae178ae"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-636-even-vs-odd-latin-squares-9b7c5790-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-636-even-vs-odd-latin-squares-9b7c5790-root",
      "route_id": "route:um-opg-636-even-vs-odd-latin-squares-9b7c5790-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-636-540faeca6219",
        "url": "https://www.unsolvedmath.com/problems/OPG-636"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
